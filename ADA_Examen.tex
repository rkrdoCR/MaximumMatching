...
\begin{tikzpicture}[node distance = {2.5cm and 5cm}, v/.style = {draw, circle}]
   \graph[nodes={circle, minimum size=1cm, draw}, grow right=5cm, branch down=2.5cm] {subgraph I_nm [V={A,B,C,D,E}, W={F,G,H,I,J}];
  A -- {F,I};
  B -- {G,H,I,J};
  C -- {G};
  D -- {H};
